...
echo "deb [arch=arm64] https://archive.heckel.io/apt debian main" > /etc/apt/sources.list.d/archive.heckel.io.list
...
curl -L "https://github.com/docker/compose/releases/download/v2.2.3/docker-compose-linux-aarch64" -o /usr/local/bin/docker-compose
chmod +x /usr/local/bin/docker-compose

## install CronitorCLI

curl -sOL https://github.com/cronitorio/cronitor-cli/releases/download/28.8/linux_arm64.tar.gz
...
wget https://github.com/r-darwish/topgrade/releases/download/v8.2.0/topgrade-v8.2.0-aarch64-unknown-linux-gnu.tar.gz
tar -xvf topgrade-v8.2.0-aarch64-unknown-linux-gnu.tar.gz
mv topgrade /usr/local/bin/ && chmod +x /usr/local/bin/topgrade
rm topgrade-v8.2.0-aarch64-unknown-linux-gnu.tar.gz
